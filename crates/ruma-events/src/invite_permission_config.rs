...
use ruma_common::{ServerName, UserId};
...
pub struct InvitePermissionConfigEventContent {
    ...
    #[serde(default = "ruma_common::serde::default_true")]
    pub enabled: bool,
...
impl InvitePermissionConfigEventContent {
    ...
    pub fn user_filter_level(&self, user: &UserId) -> FilterLevel {
        if !self.enabled {
            ...
            if Self::matches(&self.allowed_users, user.as_str()) {
                FilterLevel::Allow
...
mod tests {
    ...
    use crate::{invite_permission_config::{FilterLevel, InvitePermissionConfigEventContent}, GlobalAccountDataEvent};
    ...
    fn only_goodguys() {
        let event = InvitePermissionConfigEventContent {
            enabled: true,
            allowed_servers: vec!["goodguys.org".to_string()],
            blocked_servers: vec!["*".to_string()],
            ..Default::default()
        };
    ...
    fn exclude_badguys() {
        let event = InvitePermissionConfigEventContent {
            enabled: true,
            blocked_servers: vec!["badguys.org".to_string()],
            ..Default::default()
        };
    ...
    fn only_goodguys_except_for_kevin() {
        let event = InvitePermissionConfigEventContent {
            enabled: true,
            blocked_users: vec!["@kevin:goodguys.org".to_string()],
            allowed_servers: vec!["goodguys.org".to_string()],
            blocked_servers: vec!["*".to_string()],
            ..Default::default()
        };
    ...
    fn no_badguys_except_for_alice() {
        let event = InvitePermissionConfigEventContent {
            enabled: true,
            allowed_users: vec!["@alice:badguys.org".to_string()],
            blocked_servers: vec!["badguys.org".to_string()],
            ..Default::default()
        };
    ...
    fn only_goodguys_and_ignore_reallybadguys() {
        let event = InvitePermissionConfigEventContent {
            enabled: true,
            allowed_servers: vec!["goodguys.org".to_string()],
            ignored_servers: vec!["reallybadguys.org".to_string()],
            blocked_servers: vec!["*".to_string()],
            ..Default::default()
        };
